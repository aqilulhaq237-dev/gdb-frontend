    ...
    <div className="container mt-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <div className="d-flex align-items-center gap-2">
          ...
          <button className="btn btn-outline-secondary me-2" onClick={() => onNavigate("dashboard")}>Dashboard</button>
                    ...
                    <tr key={item.id_pengajuan}>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          <button className="btn btn-sm btn-success" onClick={() => handleSetujui(item.id_pengajuan)}>✅ Setujui</button>
                          <button className="btn btn-sm btn-danger" onClick={() => { setSelectedPengajuan(item); setShowModal(true); }}>❌ Tolak</button>
                        </div>
                      </td>
                    </tr>
                  ))}
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="mb-3">
                  ...
                  <textarea className="form-control" rows="3" value={catatanTolak} onChange={(e) => setCatatanTolak(e.target.value)} placeholder="Masukkan alasan penolakan..." />
                </div>
              </div>
              <div className="modal-footer">
                <button type="button" className="btn btn-secondary" onClick={() => setShowModal(false)}>Batal</button>
                <button type="button" className="btn btn-danger" onClick={() => { if (!catatanTolak) { alert("⚠️ Isi catatan penolakan!"); return; } handleTolak(selectedPengajuan.id_pengajuan); }}>Konfirmasi Tolak</button>
              </div>
            </div>
          </div>
        </div>
