...
function App() {
  ...
  const pages = {
    'dashboard': <Dashboard user={user} onLogout={handleLogout} onNavigate={setCurrentPage} />,
    'program-kerja': <ProgramKerja user={user} onLogout={handleLogout} onNavigate={setCurrentPage} />,
    'kelola-rab': <KelolaRABDinamis user={user} onLogout={handleLogout} onNavigate={setCurrentPage} />,
    'transaksi': <TransaksiKas user={user} onLogout={handleLogout} onNavigate={setCurrentPage} />,
    'update-status': <UpdateStatusProgram user={user} onLogout={handleLogout} onNavigate={setCurrentPage} />,
    'konfirmasi-transaksi': <KonfirmasiTransaksi user={user} onLogout={handleLogout} onNavigate={setCurrentPage} />,
    'periode-aktif': <KelolaPeriodeAktif user={user} onLogout={handleLogout} onNavigate={setCurrentPage} />,
    'kelola-biaya': <KelolaBiaya user={user} onLogout={handleLogout} onNavigate={setCurrentPage} />,
    'profil': <Profil user={user} onLogout={handleLogout} onNavigate={setCurrentPage} onProfileUpdate={setUser} />,
